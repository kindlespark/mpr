...
export class InputBox extends Component {
	...
	componentDidMount() {
		var self = this;
		$("#input-dialog.modal").modal();
		$("#input-dialog.modal").on("hidden.bs.modal", function (e) {
	...
	onClickSubmitButton(e) {
		var text = $("#input-dialog.modal").find(".input-control").val();
	...
	render() {
		return (
			<div id="input-dialog" className="modal" tabIndex="-1" role="dialog">
