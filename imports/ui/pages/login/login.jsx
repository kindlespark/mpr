			...
			return (
				<div className="page-container container" id="content">
					<form id="login_form" className="account-form" role="form" onSubmit={this.onLoginWithPassword}>
						...
						<button id="login-with-google" type="button" className="btn btn-default btn-block" data-loading-text="Please wait..." onClick={this.onLoginWithGoogle}>
							<span className="fa fa-google-plus-square">
							</span>
							&nbsp;Sign in with Google
						</button>
...
export const LoginPageContainer = withTracker(function(props) {
