...
export const TeachersPageContainer = withTracker(function(props) {
	...
	let teacherListPagedExtraParams = {
		...
		searchFields: Session.get("TeacherListPagedSearchFields") || ["firstName", "lastName", "email"],
...
export class TeachersPageView extends Component {
	...
	componentWillMount() {
		Session.set("TeacherListPagedSearchFields", ["firstName", "lastName", "email"]);
	...
	exportData(fileType) {
		...
		let exportFields = ["firstName", "lastName", "email"];
