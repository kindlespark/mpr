					...
					{this.state.teachersInsertPageInsertFormInfoMessage ? this.renderInfoMessage() : null}
								<div className="form-group  field-first-name">
									...
									<div className="input-div">
										<input type="text" name="firstName" defaultValue="" className="form-control " autoFocus="autoFocus" required="required" />
						...
						<div className="input-div">
							<input type="text" name="lastName" defaultValue="" className="form-control " />
							<span id="help-text" className="help-block" />
							<span id="error-text" className="help-block" />
						</div>
					</div>
