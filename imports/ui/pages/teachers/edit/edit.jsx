			...
			<div id="teachers-edit-page-edit-form" className="">
				...
				<form role="form" onSubmit={this.onSubmit}>
					...
					{this.state.teachersEditPageEditFormInfoMessage ? this.renderInfoMessage() : null}
								<div className="form-group  field-last-name">
									...
									<div className="input-div">
										<input type="text" name="lastName" defaultValue={this.props.data.teacher_details.lastName} className="form-control " autoFocus="autoFocus" required="required" />
						...
						<div className="input-div">
							<input type="text" name="firstName" defaultValue={this.props.data.teacher_details.firstName} className="form-control " />
							<span id="help-text" className="help-block" />
							<span id="error-text" className="help-block" />
						</div>
					</div>
					...
					<div className="form-group  field-school-id">
						...
						<div className="input-div">
							<select className="form-control " name="schoolId" defaultValue={this.props.data.teacher_details.schoolId} required="required">
